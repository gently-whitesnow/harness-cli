...
- [ADR-0027](0027-strict-repository-policy.md) — Явный `policy: strict` превращает каждую
  оставшуюся advisory-находку выбранной проверки в blocking-нарушение; `required` сохраняет
  исходную уверенность проверки, а suppress применяется до усиления.
