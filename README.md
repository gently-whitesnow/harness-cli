...
с константами стандарта: 8.0 файла и 0. Числа зашиты в бинарь, как и таблица слоёв; у проверки нет
настроек, единственная гибкость — уровень `policy`. Превышение блокирует `check`, а отчёт называет
...
Отчёт печатает архитектуру и DSM-пределы рядом с текущими значениями и областью измерения;
