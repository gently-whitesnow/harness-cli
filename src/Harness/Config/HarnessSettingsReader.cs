...
internal static class HarnessSettingsReader
{
    public static (HarnessSettings? Settings, string? Failure) Read(JsonElement root)
    {
        ...
        var known = new[] { "comments.csharp", "maintainability.csharp" };
        ...
        return maintainability is null
            ? (null, maintainabilityFailure)
            : (new HarnessSettings(comments, maintainability), null);
    }
