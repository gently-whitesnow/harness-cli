...
/// applicability it shares, and — for a frame question — which answer key it reads and the
/// release that introduced it. The frame validates a document against this description and
