...
(function () {
  ...
  const CHECKS = [
    ...
    { id: 'comments.yaml', group: 'langs', axis: 'yaml', summary: 'Плотность прозы YAML: от 10 строк и больше 8%. Блоки над ключами любой глубины, trailing-комментарии и директивы исключены; init без прикладного языка ставит advisory.', adr: ['0043-comment-density-across-languages.md', '0056-configuration-repository-frame.md'] },
    ...
    { id: 'secrets.ansible', group: 'ansible', axis: 'ansible', summary: 'Литералы от 8 символов под узким словарём имён секретов в vars; публичные ключи и ссылки на поля исключены. По умолчанию advisory.', adr: ['0057-ansible-axis.md'] },
    ...
    { id: 'role-shape.ansible', group: 'ansible', axis: 'ansible', summary: 'Каталоги роли по словарю Ansible; при наличии tasks нужен main.yml или main.yaml. По умолчанию advisory.', adr: ['0057-ansible-axis.md'] },
