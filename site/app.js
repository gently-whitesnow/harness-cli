/* Harness CLI landing · contract 3.9.0 · no dependencies. */
(function () {
  'use strict';
  ...
  const CHECKS = [
    { id: 'harness.config', group: 'common', axis: null, summary: 'Tracked .harness.json: одна корневая версия, явные проекты workspace и локальные рамки без наследования; проверка вне policy — вне рамки.', adr: ['0014-frame-answers-are-self-reported.md', '0016-versioned-frame-and-explicit-initialization.md', '0054-explicit-only-frame.md', '0060-explicit-workspace-projects.md'] },
    { id: 'harness.coverage', group: 'common', axis: null, summary: 'Язык или стек с tracked-исходниками должен быть объявлен в applicability или отклонён с причиной; находка печатает готовый фрагмент конфига. Generated-маркер вне объявленного generated и пустое объявление блокируют; исключённые пути видны в scope.', adr: ['0054-explicit-only-frame.md', '0067-reviewed-weakening-in-the-frame.md'] },
    ...
    { id: 'docs.policy', group: 'common', axis: null, summary: 'Короткие AGENTS.md и README.md — до 150 строк; перевод README.<язык>.md — рядом с README.md, с тем же лимитом. CLAUDE.md ссылается на соседний AGENTS.md; решения живут в adrs/, навыки — в skills/<name>/SKILL.md и зеркалах агентского тулчейна. DESIGN.md и файлы форджа (community health, шаблоны issue/PR в корне, .github/, docs/) разрешены без лимита. Прочий Markdown запрещён.', adr: ['0010-documentation-policy.md', '0025-nested-agent-documents.md', '0061-forge-and-design-documents.md', '0068-readme-translations.md'] },
    ...
    { id: 'complexity.typescript', group: 'langs', axis: 'typescript', summary: 'DSM по файлам TS/JS с прозрачными barrels; стартовые пределы: средняя достижимость 8, циклическая группа 0.', adr: ['0064-typescript-language-axis.md'] },
    ...
    { id: 'comments.go', group: 'go', axis: 'go', summary: 'Плотность комментариев в Go: от 10 строк и больше 8%. Doc-комментарии top-level деклараций и директивы //go: не считаются; generated исключается по объявлению в рамке, vendor и testdata — по правилам Go.', adr: ['0055-go-language-axis.md', '0043-comment-density-across-languages.md'] },
    ...
    { id: 'lint-suppressions.go', group: 'go', axis: 'go', summary: 'Любой адресный //nolint блокируется. Глобальные отключения линтеров требуют id и причины в settings.lint-suppressions.go.repositoryWide; сам линтер не запускается.', adr: ['0055-go-language-axis.md', '0044-editorconfig-baseline-and-warning-suppressions.md'] },
    { id: 'lint-suppressions.ansible', group: 'ansible', axis: 'ansible', summary: 'Любой inline # noqa блокируется; skip_list и warn_list требуют id и причины в settings.lint-suppressions.ansible.repositoryWide.', adr: ['0057-ansible-axis.md'] },
    ...
    { id: 'editorconfig.dotnet', group: 'dotnet', axis: 'dotnet', summary: 'Единый эталон стиля в .editorconfig над каждым проектом. harness explain editorconfig.dotnet показывает его целиком.', adr: ['0044-editorconfig-baseline-and-warning-suppressions.md', '0067-reviewed-weakening-in-the-frame.md'] },
    { id: 'warning-suppressions.dotnet', group: 'dotnet', axis: 'dotnet', summary: 'Запрещает подавлять предупреждения для отдельного файла или места. Глобальное отключение требует id и причины в settings.warning-suppressions.dotnet.repositoryWide и печатается в обычном отчёте.', adr: ['0044-editorconfig-baseline-and-warning-suppressions.md'] },
