...
(function () {
  ...
  const CHECKS = [
    ...
    { id: 'complexity.csharp', group: 'arch', axis: 'csharp', summary: 'DSM по продукту: внутри архитектурных зон, а без зоны — вне tracked тестовых проектов. Mean reach ≤ 8.0 файла и core size = 0 — константы стандарта в бинаре, без настроек и tracked-числа; превышение блокирует, отчёт называет файлы вне Host с наибольшей достижимостью.', adr: ['0032-topology-over-thresholds.md', '0042-dsm-over-the-product-in-files.md', '0048-dsm-product-boundary-without-a-zone.md', '0052-dsm-limits-are-constants-of-the-standard.md'] },
  ...
  const GROUPS = [
    ...
    { key: 'arch', title: 'Архитектура и DSM', note: 'Первый и второй ярусы контракта 2.0. Секция architecture выбирает стандарт sliced-dotnet/1 либо applicable: false; DSM сравнивается с константами стандарта — 8.0 файла mean reach и ядро 0.' },
  ...
  const DSM_LIMIT = { meanReach: 8, core: 0 };
