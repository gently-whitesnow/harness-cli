...
public sealed class HarnessFrameTests
{
    ...
    [InlineData("{ \"complexity.csharp\": { \"averageReachableFiles\": 0.5, \"largestCyclicGroupSize\": 0 } }", "not below 1")]
    [InlineData("{ \"complexity.csharp\": { \"averageReachableFiles\": 8, \"largestCyclicGroupSize\": -1 } }", "non-negative integer")]
