...
public sealed class Frame
{
    private const string DefaultSettings =
        """{ "comments.csharp": { "minimumCommentLines": 10, "percentageLimit": 8 }, "comments.yaml": { "minimumCommentLines": 10, "percentageLimit": 8 }, "comments.typescript": { "minimumCommentLines": 10, "percentageLimit": 8 }, "duplication.typescript": { "windowLines": 30, "minimumTokens": 90 }, "complexity.typescript": { "averageReachableFiles": 12.0, "largestCyclicGroupSize": 0 }, "duplication.csharp": { "windowLines": 30, "minimumTokens": 90 }, "complexity.csharp": { "averageReachableFiles": 8.0, "largestCyclicGroupSize": 0 }, "functions.csharp": { "ownLines": 80 }, "comments.go": { "minimumCommentLines": 10, "percentageLimit": 8 }, "duplication.go": { "windowLines": 30, "minimumTokens": 90 }, "complexity.go": { "averageReachableFiles": 8.0, "largestCyclicGroupSize": 0 }, "functions.go": { "ownLines": 80 }, "commits": { "language": "ru", "requireSetup": false } }""";
